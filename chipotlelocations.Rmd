...
# working directory should be 'archive' folder that results from unzipping downloaded 'archive.zip' to load 'chipotle_stores.csv'
chipotledf <- read.csv("chipotle_stores.csv")
